...
<link href="<?php echo assets_url("common/css/jquery.treeview.css"); ?>" rel="stylesheet" type="text/css"/>
<script src="<?php echo assets_url("common/javascript/jquery.treeview.js"); ?>" type="text/javascript"></script>
