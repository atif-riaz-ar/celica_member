				...
				<form method="post" action="<?php echo base_url("withdraw/confirm") ?>" class="form-horizontal">
					<div class="form-group basic">
						...
						<div class="form-group basic input-prepend">
							...
							<div class="input-wrapper">
								<input id="txtAmtToWithdraw" name="txtAmtToWithdraw"
									   class="form-control uneditable-input" value="0.00" readonly>
							</div>
						</div>
						...
						<div class="form-group basic">
							...
							<div class="input-wrapper">
								<select name="selPaymentMode" id="selPaymentMode" class="form-control"
					...
					<div class="form-group basic">
						<div class="input-wrapper">
							<button type="submit" class="btn btn-success btn-lg btn-block" id="btnNext"
									name="btnNext">
								[[DEF_WITHDRAW]]
							</button>
						</div>
					...
					<div class="form-group basic">
						<div class="input-wrapper">
							<a href="<?php echo base_url("reports/withdrawal") ?>"  class="btn btn-success btn-lg btn-block"
									>
								[[DEF_WITHDRAWAL_HISTORY]]
							</a>
						</div>
					</div>
				</form>
